                          ...
                          <tr>
                            ...
                            <td>
                              <div style="display: flex; gap: 8px;">
                                <a href="{{ route('dashboard.useredit', ['id' => $member->id]) }}" class="btn btn-secondary btn-sm">Edit</a>
                                <form action="{{ route('dashboard.userdelete', ['id' => $member->id]) }}" method="POST" style="display: inline;">
                                  @csrf
                                  @method('DELETE')
