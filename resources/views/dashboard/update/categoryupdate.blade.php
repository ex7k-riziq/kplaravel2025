        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-1 px-4 px-sm-5">
                <div class="card-body">
                    <h2 class="card-title py-3">Edit category data</h2>
                    ...
                    <form class="forms-sample" method="POST" action="{{ route('dashboard.categoryupdate', $category) }}" enctype="multipart/form-data">
                      @csrf
                      @method('PUT')
